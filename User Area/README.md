...
- User Area: info about the items that the costumer has saved and it's going to buy. / Management Area: a page where the owner of the shop can handle all the data of the shop.
    ...
    ### USER AREA
    The "User Area" page is personal area of each user where it's possible to access only if you're logged as default user. Inside this page there are a list with personal information of the user, his orders, his saved photos, the photos in the cart and all his reviews.
    

## VISUALS

![image](https://user-images.githubusercontent.com/79788825/119384639-4d83e200-bcc5-11eb-9ec2-5e5f36ea4f03.png)
